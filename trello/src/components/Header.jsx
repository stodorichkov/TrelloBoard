        ...
        if (localStorage.getItem('username')) {
            return  <>
                ...
                <Grid item>
                    ...
                    >
                        <WorkspaceForm handleCloseWorkspaceForm={handleCloseWorkspaceForm} setWorkspaces={props.setWorkspaces} setCurrentWorkspace={props.setCurrentWorkspace} formPurpose={"new"} oldName={""}/>
                    </Modal>
                </Grid>
            </>
        }
