            ...
            <Grid item xs={12} sm={12} md={12}>
                <Card >
                    ...
                    <CardActions>
                        ...
                        >
                            <TicketInfo handleCloseTicketInfo={handleCloseTicketInfo} card={props.card} column={props.column} setCurrentWorkspace={props.setCurrentWorkspace} setWorkspaces={props.setWorkspaces}/>
                        </Modal>
                        <IconButton 
                            aria-label="settings" 
                            color='primary'
